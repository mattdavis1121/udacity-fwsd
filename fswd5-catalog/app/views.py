...
@app.route('/edit-category/<category_id:int>', methods=('GET', 'POST'))
@login_required
...
@app.route('/delete-category/<category_id:int>')
@login_required
...
@app.route('/edit-product/<product_id:int>', methods=('GET', 'POST'))
@login_required
...
@app.route('/delete-product/<product_id:int>')
@login_required
